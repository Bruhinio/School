                  ...
                  <div>
                    ...
                    <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(140px,1fr))",gap:10}}>
                      {studs.map(s=>{
                        ...
                        return(
                          <div key={s.id} onClick={()=>setSelStu(s)} style={{background:"#fff",borderRadius:16,padding:"14px 12px",textAlign:"center",cursor:"pointer",boxShadow:"0 1px 8px rgba(0,0,0,0.07)",border:`1px solid ${C.sep}`,transition:"transform 0.15s"}}
                            ...
                            ):<span style={{fontSize:11,color:C.lbl3,fontFamily:SF}}>Sin calificación</span>}
                          </div>
                        );
                      })}
                    </div>
