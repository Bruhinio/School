...
const ChatPanel=({state,setState,myUserId,myName,myAvatar,myColor,role,accent=C.blue})=>{
  ...
  if(view==="chat"&&selectedChat){
    ...
    return(
      <div style={{background:"#f0f2f5",height:"calc(var(--vh,1vh)*100)",maxHeight:"-webkit-fill-available",fontFamily:SF_local,display:"flex",flexDirection:"column",overflow:"hidden"}}>
        {/* Header */}
