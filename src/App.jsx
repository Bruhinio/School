...
const AppSidebar=({open,onToggle,gradient,logoEmoji="🏫",logoLine1="Instituto",logoLine2="Educativo",
  userEmoji,userName,userSub,navItems=[],onLogout,profileInitials=null,profilePic=null,profileColor=null})=>{
        ...
        <div style={{
          ...
          <button onClick={()=>{SFX.play("click");setDrawerOpen(true);}}
            style={{
              ...
              justifyContent:"center",gap:5,padding:0,position:"relative",
            }}>
            <span style={{display:"block",width:20,height:2.5,background:"#fff",borderRadius:3}}/>
            <span style={{display:"block",width:20,height:2.5,background:"#fff",borderRadius:3}}/>
            <span style={{display:"block",width:20,height:2.5,background:"#fff",borderRadius:3}}/>
            {totalBadge>0&&(
              <div style={{position:"absolute",top:5,right:5,background:"#ef4444",color:"#fff",
                fontSize:8,fontWeight:800,borderRadius:"50%",minWidth:14,height:14,
                display:"flex",alignItems:"center",justifyContent:"center",
                border:"1.5px solid rgba(255,255,255,0.6)",fontFamily:SF}}>
          ...
          <div style={{flex:1,display:"flex",alignItems:"center",gap:8,marginLeft:10}}>
            <span style={{fontSize:22}}>{logoEmoji}</span>
            <div>
              <div style={{fontSize:16,fontWeight:800,color:"#fff",fontFamily:SF2,
                letterSpacing:"-0.3px",lineHeight:1.2}}>SCHOOLMS</div>
              <div style={{fontSize:10,color:"rgba(255,255,255,0.65)",fontFamily:SF2,
                lineHeight:1}}>{logoLine1} {logoLine2}</div>
            </div>
          </div>
