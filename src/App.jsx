...
const ChatPanel=({state,setState,myUserId,myName,myAvatar,myColor,role,accent=C.blue})=>{
  ...
  if(view==="chat"&&selectedChat){
    ...
    return(
      <div style={{background:"#f0f2f5",height:"100vh",fontFamily:SF_local,display:"flex",flexDirection:"column",overflow:"hidden"}}>
        {/* Header */}
        ...
        {/* Input bar */}
        <div style={{flexShrink:0,background:"rgba(255,255,255,0.97)",borderTop:`0.5px solid ${C.sep}`,padding:"8px 12px 16px",display:"flex",gap:8,alignItems:"flex-end"}}>
