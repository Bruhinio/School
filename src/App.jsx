            ...
            {mgmtTab==="actividades"&&(()=>{
              ...
              const sendActToChat=()=>{
                ...
                targets.forEach(t=>{
                  ...
                  const msg={id:Date.now()+Math.random(),sender:"dir",senderName:"Directora",text:msgText,time:new Date().toLocaleTimeString("es-MX",{hour:"2-digit",minute:"2-digit"})};
                  setState(s=>{
                    const chats=s.chats||[];
                    ...
                    return{
                      ...s,
                      chats:chatExists
                        ?chats.map(c=>c.id===chatId?{...c,lastMsg:msgText,lastTime:msg.time,unread:{...c.unread,[String(t.id)]:(c.unread?.[String(t.id)]||0)+1}}:c)
                        :[{id:chatId,participants,name:t.name,lastMsg:msgText,lastTime:msg.time,unread:{[String(t.id)]:1,"dir":0}},...chats],
