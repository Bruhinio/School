  ...
  if(view==="list"||view==="new"){
    ...
    return(
      <div style={{background:"#fff",
        position:"fixed",top:68,left:0,right:0,bottom:"var(--tab-h,84px)",
  ...
  if(view==="chat"&&selectedChat){
    ...
    return(
      <div style={{background:"#f0f2f5",
        ...
        bottom:"var(--tab-h,84px)",
        fontFamily:SF_local,display:"flex",flexDirection:"column",zIndex:10}}>
        {/* Messenger Header */}
        ...
        <div style={{flex:1,overflowY:"auto",padding:"8px 12px",display:"flex",
          flexDirection:"column",gap:1,WebkitOverflowScrolling:"touch"}}>
        ...
        <div style={{flexShrink:0,background:"#fff",borderTop:"1px solid #e4e6eb",
          ...
          <button onClick={sendMessage} disabled={!msgText.trim()&&attachImages.length===0&&attachFiles.length===0}
            style={{width:32,height:32,borderRadius:"50%",
              ...
              border:"none",cursor:(msgText.trim()||attachImages.length>0||attachFiles.length>0)?"pointer":"default",
