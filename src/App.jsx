        ...
        <div style={{
          ...
          <button onClick={()=>{SFX.play("click");setDrawerOpen(true);}}
            style={{
              ...
              justifyContent:"center",gap:6,padding:0,position:"relative",
            }}>
            <span style={{display:"block",width:22,height:2.5,background:"#fff",borderRadius:3}}/>
            <span style={{display:"block",width:22,height:2.5,background:"#fff",borderRadius:3}}/>
            <span style={{display:"block",width:22,height:2.5,background:"#fff",borderRadius:3}}/>
            {totalBadge>0&&(
          ...
          {/* School name — estilo Facebook */}
          <div style={{flex:1,display:"flex",alignItems:"center",gap:10,marginLeft:12}}>
            <span style={{fontSize:30,lineHeight:1,filter:"drop-shadow(0 1px 4px rgba(0,0,0,0.2))"}}>{logoEmoji}</span>
            <div style={{fontSize:26,fontWeight:800,color:"#fff",fontFamily:SFD,
