    ...
    return(
      <div style={{background:"#f0f2f5",
        ...
        <div style={{flexShrink:0,background:"#fff",borderTop:"1px solid #e4e6eb",
          padding:"8px 10px",paddingBottom:"max(8px,env(safe-area-inset-bottom,8px))",
          ...
          {[
            ...
            <button key={bi} onClick={btn.fn}
              style={{width:38,height:38,borderRadius:"50%",background:"none",border:"none",
                cursor:"pointer",fontSize:22,flexShrink:0,display:"flex",alignItems:"center",
                justifyContent:"center",color:MSN_BLUE}}>
              {btn.icon}
            </button>
          ))}
          <div style={{flex:1,background:"#f0f2f5",borderRadius:22,display:"flex",
            alignItems:"flex-end",padding:"0 6px 0 14px",minHeight:38}}>
            <textarea value={msgText} onChange={e=>setMsgText(e.target.value)}
              onKeyDown={e=>{if(e.key==="Enter"&&!e.shiftKey){e.preventDefault();sendMessage();}}}
              placeholder="Aa" rows={1}
              style={{flex:1,background:"transparent",border:"none",padding:"9px 0",fontSize:15,
                color:"#050505",fontFamily:SF_local,outline:"none",resize:"none",lineHeight:"20px",
          ...
          <button onClick={sendMessage} disabled={!msgText.trim()&&attachImages.length===0&&attachFiles.length===0}
            style={{width:38,height:38,borderRadius:"50%",
              ...
              boxShadow:(msgText.trim()||attachImages.length>0||attachFiles.length>0)?"0 2px 10px rgba(0,132,255,0.4)":"none",
              transition:"all 0.15s"}}
...
const DirectorApp=({state,setState,onLogout})=>{
  ...
  const DirBellBtn=()=>(
    <div style={{position:"fixed",top:78,right:16,zIndex:500}}>
      <button onClick={()=>setDirBellOpen(o=>!o)}
        style={{width:38,height:38,borderRadius:"50%",
          background:dirBellOpen?C.fill3:`linear-gradient(135deg,${DIR_ACCENT},${DIR_ACCENT}bb)`,
          border:"none",cursor:"pointer",display:"flex",alignItems:"center",
          justifyContent:"center",fontSize:16,boxShadow:"0 2px 10px rgba(0,0,0,0.12)",
          transition:"all 0.15s",position:"relative"}}>
        🔔
        {dirUnreadCount>0&&<span style={{position:"absolute",top:-4,right:-4,
          background:dirUrgentCount>0?C.red:C.indigo,color:"#fff",fontSize:9,fontWeight:800,
          borderRadius:"50%",minWidth:16,height:16,display:"flex",alignItems:"center",
      ...
      {dirBellOpen&&(
        <>
          ...
          <div style={{position:"fixed",top:78,right:14,width:300,maxHeight:"70vh",
      ...
      <div style={{flex:1,minWidth:0,minHeight:"100vh",overflowX:"hidden"}}>
        ...
        {tab==="management"&&(
          <div>
            ...
            {mgmtTab==="grupos"&&<DirGruposPanel state={state}/>}
    ...
    <div style={{position:"fixed",top:78,right:16,zIndex:500}}>
      <button onClick={()=>setBellOpen(o=>!o)}
        style={{width:38,height:38,borderRadius:"50%",
          ...
          border:"none",cursor:"pointer",display:"flex",alignItems:"center",
          justifyContent:"center",fontSize:16,boxShadow:"0 2px 8px rgba(0,0,0,0.12)",
          transition:"all 0.15s",position:"relative"}}>
        🔔
