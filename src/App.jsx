...
const TabBar=({tabs,active,onChange,accent=C.blue})=>(
  <div className="tab-bar-bottom" style={{position:"fixed",bottom:0,left:0,right:0,zIndex:300,
    ...
    <>
      ...
      <style>{`
        *{box-sizing:border-box;margin:0;padding:0;-webkit-font-smoothing:antialiased;}
        ...
        .app-root{max-width:600px;margin:0 auto;position:relative;}
        @media(min-width:768px){
          .app-root{max-width:768px;}
          .tab-bar-desktop{display:flex!important;}
        }
        @media(min-width:1024px){
          .app-root{max-width:1200px;display:grid;grid-template-columns:260px 1fr;min-height:100vh;}
          .side-nav{display:flex!important;}
          .tab-bar-bottom{display:none!important;}
          .main-content{border-left:1px solid rgba(60,60,67,0.12);}
        }
