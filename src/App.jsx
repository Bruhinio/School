...
const ANIMAL_HEADS={
  owl:      {x:50,y:26}, // large round head, centered, ears at top
  bear:     {x:50,y:26}, // round bear head, ears at top
  whale:    {x:36,y:36}, // horizontal whale, head at left side
  elephant: {x:50,y:28}, // large round head with trunk below
  giraffe:  {x:50,y:18}, // tiny head atop long neck — head high but inside viewBox
  lion:     {x:50,y:28}, // big mane, face center slightly lower
  fox:      {x:50,y:26}, // pointed muzzle, head upper area
  rabbit:   {x:50,y:30}, // body-centered (ears go way above, hat should sit on ears)
  dragon:   {x:50,y:26},
  cat:      {x:50,y:26},
  default:  {x:50,y:26},
};
...
const MascotSVG=({subject,outfit,size=80,animal=null})=>{
  ...
  const Birrete=()=>T(<><rect x="-19" y="-34" width="38" height="7" rx="2" fill="#1a1a2e"/><rect x="-13" y="-42" width="26" height="9" rx="2" fill="#1a1a2e"/><line x1="11" y1="-40" x2="21" y2="-31" stroke="#FFD700" strokeWidth="2.5" strokeLinecap="round"/><circle cx="22" cy="-30" r="3.5" fill="#FFD700"/></>);
  const Corona=()=>T(<><path d="M-20 -26 L-20 -38 L-8 -30 L0 -44 L8 -30 L20 -38 L20 -26 Z" fill="#FFD700"/><line x1="-20" y1="-26" x2="20" y2="-26" stroke="#F9A825" strokeWidth="2"/><circle cx="0" cy="-43" r="3.5" fill="#E53935"/><circle cx="-19" cy="-37" r="2.5" fill="#4CAF50"/><circle cx="19" cy="-37" r="2.5" fill="#4CAF50"/><circle cx="-8" cy="-29" r="2" fill="#2196F3"/><circle cx="8" cy="-29" r="2" fill="#2196F3"/></>);
  const SombreroPaja=()=>T(<><ellipse cx="0" cy="-26" rx="28" ry="6" fill="#F9A825"/><path d="M-22 -26 Q-20 -42 0 -44 Q20 -42 22 -26" fill="#F9A825"/><ellipse cx="0" cy="-27" rx="16" ry="4" fill="#F57F17" opacity="0.5"/></>);
  const SombreroVaquero=()=>T(<><ellipse cx="0" cy="-24" rx="26" ry="7" fill="#6D4C41"/><path d="M-20 -24 Q-18 -42 0 -44 Q18 -42 20 -24" fill="#795548"/><ellipse cx="0" cy="-25" rx="14" ry="4" fill="#5D4037" opacity="0.5"/><path d="M-20 -23 Q0 -16 20 -23" stroke="#4E342E" strokeWidth="1.5" fill="none"/></>);
  const CascoAntiguo=()=>T(<><path d="M-26 -12 Q-28 -36 0 -38 Q28 -36 26 -12 L26 -8 L-26 -8 Z" fill="#B0BEC5"/><rect x="-6" y="-38" width="12" height="20" rx="3" fill="#CFD8DC"/><ellipse cx="0" cy="-8" rx="26" ry="5" fill="#90A4AE"/><path d="M-26 -8 L-32 6 L-22 6 L-18 -8" fill="#B0BEC5"/><path d="M26 -8 L32 6 L22 6 L18 -8" fill="#B0BEC5"/></>);
  const SombreroTeatro=()=>T(<><ellipse cx="0" cy="-24" rx="28" ry="6" fill="#6A1B9A"/><path d="M-22 -24 Q-20 -42 0 -44 Q20 -42 22 -24" fill="#4A148C"/><ellipse cx="0" cy="-25" rx="16" ry="4" fill="#7B1FA2" opacity="0.5"/><circle cx="-10" cy="-34" r="3" fill="#FFD700"/><circle cx="10" cy="-34" r="3" fill="#FFD700"/><circle cx="0" cy="-39" r="3.5" fill="#FF6F00"/></>);

  // ── FACE accessories (at eye level) ──────────────────────────────────────
  const GafasNerd=()=>T(<><circle cx="-13" cy="4" r="9" fill="none" stroke="#222" strokeWidth="2.2"/><circle cx="13" cy="4" r="9" fill="none" stroke="#222" strokeWidth="2.2"/><line x1="-4" y1="4" x2="4" y2="4" stroke="#222" strokeWidth="2.2"/><line x1="-22" y1="4" x2="-28" y2="2" stroke="#222" strokeWidth="2.2" strokeLinecap="round"/><line x1="22" y1="4" x2="28" y2="2" stroke="#222" strokeWidth="2.2" strokeLinecap="round"/><circle cx="-13" cy="4" r="6" fill="#E3F2FD" opacity="0.4"/><circle cx="13" cy="4" r="6" fill="#E3F2FD" opacity="0.4"/></>);
  const GafasLab=()=>T(<><rect x="-27" y="-2" width="54" height="14" rx="6" fill="#4FC3F7" opacity="0.5" stroke="#0277BD" strokeWidth="2"/><line x1="0" y1="-2" x2="0" y2="12" stroke="#0277BD" strokeWidth="1.5"/><line x1="-27" y1="5" x2="-35" y2="3" stroke="#0277BD" strokeWidth="2.5" strokeLinecap="round"/><line x1="27" y1="5" x2="35" y2="3" stroke="#0277BD" strokeWidth="2.5" strokeLinecap="round"/></>);

  // ── BODY accessories (below head) ─────────────────────────────────────────
  const CapaHeroe=()=>T(<><rect x="-14" y="22" width="28" height="5" rx="2" fill="#FFD700"/><path d="M-14 27 Q-18 38 -16 54 L0 47 L16 54 Q18 38 14 27 Z" fill="#E53935"/><path d="M-14 27 Q-7 33 0 30 Q7 33 14 27" fill="#B71C1C" opacity="0.7"/></>);
  const BataBlanca=()=>T(<><path d="M-22 18 L-28 58 L28 58 L22 18 Q10 24 0 22 Q-10 24 -22 18Z" fill="white" stroke="#B0BEC5" strokeWidth="1.5"/><path d="M0 22 L0 58" stroke="#CFD8DC" strokeWidth="1"/><circle cx="0" cy="32" r="2" fill="#90A4AE"/><circle cx="0" cy="40" r="2" fill="#90A4AE"/><circle cx="0" cy="48" r="2" fill="#90A4AE"/></>);
  const TrajeEspacial=()=>T(<><circle cx="0" cy="2" r="26" fill="#E3F2FD" stroke="#1565C0" strokeWidth="2.5" opacity="0.88"/><ellipse cx="-5" cy="-8" rx="9" ry="6" fill="white" opacity="0.45"/><circle cx="0" cy="2" r="26" fill="none" stroke="#90CAF9" strokeWidth="1.5" opacity="0.5"/></>);

  // ── SIDE accessories (held to side) ───────────────────────────────────────
  const LupaArqueologo=()=>T(<><circle cx="30" cy="-2" r="14" fill="none" stroke="#37474F" strokeWidth="2.5"/><circle cx="30" cy="-2" r="10" fill="#E3F2FD" opacity="0.55"/><circle cx="26" cy="-6" r="3" fill="white" opacity="0.4"/><line x1="20" y1="9" x2="8" y2="22" stroke="#37474F" strokeWidth="3.5" strokeLinecap="round"/></>);
  const Pergamino=()=>T(<><rect x="18" y="-12" width="22" height="32" rx="3" fill="#FFF9C4" stroke="#F9A825" strokeWidth="1.5"/><ellipse cx="29" cy="-12" rx="11" ry="3.5" fill="#FFE082"/><ellipse cx="29" cy="20" rx="11" ry="3.5" fill="#FFE082"/><line x1="22" y1="-4" x2="36" y2="-4" stroke="#F9A825" strokeWidth="1.3"/><line x1="22" y1="2" x2="36" y2="2" stroke="#F9A825" strokeWidth="1.3"/><line x1="22" y1="8" x2="36" y2="8" stroke="#F9A825" strokeWidth="1.3"/></>);
  const Pluma=()=>T(<><path d="M26 -20 Q40 -10 32 6 Q24 16 18 26" fill="#FFF8E1" stroke="#FFA000" strokeWidth="1.5"/><path d="M26 -20 Q18 -6 18 26" fill="#FFE082" opacity="0.65"/><path d="M18 26 L15 38" stroke="#5D4037" strokeWidth="2.5" strokeLinecap="round"/></>);
  const LibroMagico=()=>T(<><rect x="18" y="-8" width="26" height="34" rx="3" fill="#7B1FA2"/><rect x="20" y="-6" width="22" height="30" rx="2" fill="#CE93D8"/><line x1="31" y1="-6" x2="31" y2="24" stroke="#7B1FA2" strokeWidth="2"/><circle cx="31" cy="10" r="5" fill="#FFD700" opacity="0.9"/><path d="M28 8 L31 5 L34 8 L33 13 L29 13 Z" fill="#FFF176"/></>);
  const EstrellaAutor=()=>T(<><path d="M0 -30 L5 -18 L18 -18 L8 -10 L12 2 L0 -6 L-12 2 L-8 -10 L-18 -18 L-5 -18 Z" fill="#FFD700" stroke="#F9A825" strokeWidth="1"/><path d="M0 -30 L3 -22 L10 -22 L4 -17 L7 -9 L0 -14 L-7 -9 L-4 -17 L-10 -22 L-3 -22 Z" fill="#FFF176" opacity="0.6"/></> );
      ...
      <div style={{background:"#f0f2f5",
        ...
        <div style={{flexShrink:0,background:"#fff",borderTop:"1px solid #e4e6eb",
          ...
          <button
            ...
            onPointerUp={e=>{e.currentTarget.style.transform="scale(1)";sendMessage();}}
            ...
            style={{width:34,height:34,borderRadius:"50%",
              ...
              transition:"background 0.15s, box-shadow 0.15s",touchAction:"manipulation"}}>
