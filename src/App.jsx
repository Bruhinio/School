...
const NavBar=({title,large,sub,right,back,onBack,accent=C.blue,bg="rgba(242,242,247,0.88)",profilePic=null,profileInitials=null,profileColor=null})=>{
  const R = useR();
  const ProfileAvatar=()=>profileInitials?(
    <div style={{width:34,height:34,borderRadius:"50%",overflow:"hidden",flexShrink:0,
      border:`2px solid ${accent}30`,boxShadow:"0 1px 6px rgba(0,0,0,0.12)",cursor:"pointer"}}>
      {profilePic
        ?<img src={profilePic} style={{width:"100%",height:"100%",objectFit:"cover"}}/>
        :<div style={{width:"100%",height:"100%",background:`linear-gradient(135deg,${profileColor||accent},${profileColor||accent}99)`,
          display:"flex",alignItems:"center",justifyContent:"center",
          fontSize:13,fontWeight:800,color:"#fff",fontFamily:SF}}>{profileInitials}</div>}
    </div>
  ):null;
  return(
    <div style={{position:"sticky",top:0,zIndex:200,background:bg,
      ...
      <div style={{display:"flex",alignItems:"center",
        ...
        {!right&&<ProfileAvatar/>}
        {right&&<div style={{marginLeft:6}}><ProfileAvatar/></div>}
      </div>
...
const SchoolMSFooter=()=>(
  <div style={{
    ...
    padding:"4px 0 max(5px,env(safe-area-inset-bottom,5px))",
    display:"flex",alignItems:"center",justifyContent:"center",
...
const TabBar=({tabs,active,onChange,accent=C.blue})=>{
  ...
  // Mobile: navigation is handled by the AppSidebar drawer — hide TabBar
  if(isDesktop===false && R.tabH!==0) return null;
...
const AppSidebar=({open,onToggle,gradient,logoEmoji="🏫",logoLine1="Instituto",logoLine2="Educativo",
  userEmoji,userName,userSub,navItems=[],onLogout,profilePic=null,profileInitials=null,profileColor=null})=>{
  const {isMobile}=useBreakpoint();
  const [drawerOpen,setDrawerOpen]=useState(false);
  const SF2="-apple-system,'SF Pro Text','Helvetica Neue',sans-serif";
  const closeDrawer=()=>setDrawerOpen(false);

  // ── MOBILE: hamburger top bar + Facebook-style slide-out drawer ─────────────
  if(isMobile){
      ...
      <>
        ...
        <div style={{
          ...
          <button onClick={()=>{SFX.play("click");setDrawerOpen(true);}}
            ...
            <span style={{display:"block",width:20,height:2,background:"#fff",borderRadius:2}}/>
            {totalBadge>0&&(
              <div style={{position:"absolute",top:6,right:6,background:"#ef4444",color:"#fff",
                fontSize:9,fontWeight:800,borderRadius:"50%",minWidth:16,height:16,
                display:"flex",alignItems:"center",justifyContent:"center",
                border:"1.5px solid rgba(255,255,255,0.5)",fontFamily:SF2}}>
          ...
          {/* School name */}
          <div style={{flex:1,display:"flex",alignItems:"center",gap:8,marginLeft:10}}>
            <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
              <rect x="1" y="11" width="20" height="10" rx="2" fill="rgba(255,255,255,0.9)"/>
              <path d="M11 1L21 10H1L11 1Z" fill="rgba(255,255,255,0.9)"/>
              <rect x="8.5" y="13" width="5" height="7" rx="1" fill={gradient.includes("#3730a3")?"#4f46e5":gradient.includes("#1e40af")?"#1d4ed8":"#1e3a5f"}/>
            </svg>
            <span style={{
          ...
          {/* Profile avatar */}
          {(profileInitials||profilePic)&&(
            <div style={{width:34,height:34,borderRadius:"50%",overflow:"hidden",flexShrink:0,
              border:"2px solid rgba(255,255,255,0.4)",boxShadow:"0 1px 6px rgba(0,0,0,0.2)"}}>
              {profilePic
                ?<img src={profilePic} style={{width:"100%",height:"100%",objectFit:"cover"}}/>
                :<div style={{width:"100%",height:"100%",
                  background:"rgba(255,255,255,0.25)",
                  display:"flex",alignItems:"center",justifyContent:"center",
                  fontSize:13,fontWeight:800,color:"#fff",fontFamily:SF2}}>
                  {profileInitials||userEmoji||"?"}
                </div>}
            </div>
          )}
        </div>
        ...
        <div style={{
          ...
          background:gradient,
          boxShadow:drawerOpen?"4px 0 30px rgba(0,0,0,0.35)":"none",
            ...
            <div style={{
              ...
              <div style={{display:"flex",alignItems:"center",gap:10}}>
                <div style={{width:40,height:40,borderRadius:12,
                  ...
                  display:"flex",alignItems:"center",justifyContent:"center",
                  fontSize:20,flexShrink:0}}>{logoEmoji}</div>
                <div>
                  <div style={{fontSize:16,fontWeight:800,color:"#fff",fontFamily:SF2,lineHeight:1.2,letterSpacing:"-0.3px"}}>
                    SCHOOLMS
                  </div>
                  <div style={{fontSize:11,color:"rgba(255,255,255,0.65)",fontFamily:SF2}}>{logoLine1} {logoLine2}</div>
                </div>
              </div>
              {/* Close button */}
            ...
            {(userEmoji||userName)&&(
              <div style={{padding:"12px 16px",display:"flex",alignItems:"center",gap:12,
                ...
                <div style={{flex:1,minWidth:0}}>
                  ...
                  {userSub&&<div style={{fontSize:12,color:"rgba(255,255,255,0.65)",fontFamily:SF2,
                    overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{userSub}</div>}
                </div>
              </div>
            )}
          </div>
                ...
                <div key={item.id}>
                  <button onClick={()=>{SFX.play("click");item.onClick();closeDrawer();}}
                    ...
                    {active&&<div style={{position:"absolute",left:0,top:"50%",transform:"translateY(-50%)",
                      width:4,height:24,background:"rgba(255,255,255,0.9)",borderRadius:"0 3px 3px 0"}}/>}
                    ...
                    <span style={{fontSize:15,fontWeight:active?700:500,color:"#fff",
                    ...
                    {item.badge>0&&(
                      <span style={{background:"#ef4444",color:"#fff",fontSize:11,fontWeight:800,
                        borderRadius:10,padding:"2px 7px",fontFamily:SF2,flexShrink:0,minWidth:20,
                        textAlign:"center"}}>
                        {item.badge}
                      </span>
                    )}
                  </button>
                  {/* Sub-items (director management sub-tabs) */}
          ...
          {/* Logout */}
          <div style={{padding:"10px 10px 20px",borderTop:"1px solid rgba(255,255,255,0.12)",flexShrink:0}}>
            <button onClick={()=>{SFX.play("click");onLogout();closeDrawer();}}
              style={{width:"100%",background:"rgba(255,255,255,0.1)",
                border:"1px solid rgba(255,255,255,0.2)",
                borderRadius:14,padding:"12px 16px",color:"rgba(255,255,255,0.9)",
        ...
        {open&&(
          <div style={{display:"flex",alignItems:"center",gap:10,flex:1,minWidth:0}}>
            ...
            <div style={{minWidth:0}}>
              <div style={{fontSize:13,fontWeight:800,color:"#fff",fontFamily:SF2d,lineHeight:1.2,letterSpacing:"-0.2px"}}>SCHOOLMS</div>
              <div style={{fontSize:11,fontWeight:500,color:"rgba(255,255,255,0.65)",fontFamily:SF2d,lineHeight:1.3}}>{logoLine1} {logoLine2}</div>
            </div>
          </div>
        )}
      ...
      {(userEmoji||userName)&&(
        <div style={{padding:open?"10px 14px":"10px 8px",borderBottom:"1px solid rgba(255,255,255,0.1)",flexShrink:0}}>
          <div style={{display:"flex",alignItems:"center",gap:open?10:0,justifyContent:open?"flex-start":"center"}}>
            <div style={{width:32,height:32,borderRadius:9,background:"rgba(255,255,255,0.18)",overflow:"hidden",
              display:"flex",alignItems:"center",justifyContent:"center",fontSize:16,flexShrink:0}}>
              {profilePic?<img src={profilePic} style={{width:"100%",height:"100%",objectFit:"cover"}}/>:<span>{userEmoji}</span>}
            </div>
            {open&&<div style={{flex:1,minWidth:0}}>
              <div style={{fontSize:12,fontWeight:600,color:"#fff",fontFamily:SF2d,
                overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{userName}</div>
              {userSub&&<div style={{fontSize:10,color:"rgba(255,255,255,0.6)",fontFamily:SF2d,whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}}>{userSub}</div>}
            </div>}
          </div>
        </div>
      )}
          ...
          return(
            <div key={item.id}>
              <button onClick={item.onClick}
                ...
                {open&&<span style={{fontSize:13,fontWeight:active?700:500,color:"#fff",fontFamily:SF2d,flex:1,textAlign:"left",whiteSpace:"nowrap"}}>{item.label}</span>}
                {item.badge>0&&(
                  <span style={{background:"#ef4444",color:"#fff",fontSize:9,fontWeight:700,borderRadius:8,
                    padding:"1px 5px",fontFamily:SF2d,flexShrink:0,
                  ...
                  {item.subItems.map(sub=>(
                    <button key={sub.id} onClick={sub.onClick}
                      ...
                      <span style={{fontSize:12,fontWeight:sub.active?700:400,flex:1,textAlign:"left",
                        color:sub.active?"#fff":"rgba(255,255,255,0.75)",fontFamily:SF2d,whiteSpace:"nowrap"}}>{sub.label}</span>
                      {sub.badge>0&&<span style={{background:"#ef4444",color:"#fff",fontSize:9,fontWeight:700,borderRadius:6,padding:"1px 4px",fontFamily:SF2d}}>{sub.badge}</span>}
                    </button>
                  ))}
                </div>
              )}
      ...
      <div style={{padding:open?"8px 6px 18px":"8px 4px 18px",borderTop:"1px solid rgba(255,255,255,0.1)",flexShrink:0}}>
        <button onClick={()=>{SFX.play("click");onLogout();}}
          style={{width:"100%",background:"rgba(255,255,255,0.1)",border:"1px solid rgba(255,255,255,0.18)",
            ...
            fontSize:13,fontWeight:600,cursor:"pointer",fontFamily:SF2d,
  ...
  return(
    <div className="app-layout" style={{background:C.bg2,minHeight:"100vh",fontFamily:SF}}>
      ...
      <AppSidebar
        ...
        profileInitials="DG" profileColor={C.indigo}
        onLogout={onLogout}
        navItems={[
      ...
      <div style={{flex:1,minWidth:0,minHeight:"100vh",overflowX:"hidden"}}>
        ...
        {tab==="settings"&&(
          <div>
            <NavBar title="Ajustes" large accent={C.indigo} profileInitials="DG" profileColor={C.indigo}/>
            <div className="page-pad">
  ...
  return(
    <div className="app-layout" style={{background:C.bg2,minHeight:"100vh",fontFamily:SF}}>
      <AppSidebar
        ...
        profileInitials={teacher?.avatar} profileColor={teacher?.color}
        onLogout={onLogout}
        navItems={[
      ...
      {tab==="classes"&&(
        <div>
          <NavBar title="Mis Clases" large accent={C.blue} right={<BellBtn/>} profileInitials={teacher?.avatar} profileColor={teacher?.color}/>
          <div style={{padding:"0 16px 50px"}}>
            {myGroups.length===0&&(
      ...
      {tab==="ai"&&(
        <div>
          <NavBar title="Generador IA" large sub="Powered by Claude" accent={C.purple} right={<BellBtn/>} profileInitials={teacher?.avatar} profileColor={teacher?.color}/>
          <div className="page-pad">
            <Card style={{padding:16,marginBottom:14}}>
      ...
      {tab==="settings"&&(
        <div>
          <NavBar title="Ajustes" large accent={C.blue} right={<BellBtn/>} profileInitials={teacher?.avatar} profileColor={teacher?.color}/>
          <div className="page-pad">
            <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:8,marginBottom:24}}>
    ...
    <div className="app-layout" style={{background:T.bg,minHeight:"100vh",fontFamily:SF}}>
      ...
      {tab==="subjects"&&(
        <div style={{position:"relative",zIndex:20,minHeight:"100vh"}}>
          ...
          <NavBar title="Mis Materias" large accent={T.accent} bg={`${T.bg}ee`} profileInitials={student?.avatar} profilePic={profilePic} profileColor={student?.color}/>
      ...
      {tab==="medals"&&(
        <div style={{position:"relative",zIndex:20}}>
          <NavBar title="Mis Logros" large accent={T.accent} bg={`${T.bg}ee`} profileInitials={student?.avatar} profilePic={profilePic} profileColor={student?.color}/>
          <div className="page-pad">
      ...
      {tab==="settings"&&(
        <div>
          <NavBar title="Ajustes" large accent={T.accent} bg={`${T.bg}ee`} profileInitials={student?.avatar} profilePic={profilePic} profileColor={student?.color}/>
          <div className="page-pad">
